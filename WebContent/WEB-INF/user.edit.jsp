					...
					<div class="box box-primary box-solid">
						...
						<div class="box-body">
							<s:if test="error.error">
								<div class="alert alert-danger alert-dismissible">
									...
									<s:if test="error.failed">Có lỗi khi chỉnh sửa thông tin tài khoản.</s:if>
							...
							<div class="row">
								<div class="col-sm-6 col-xs-12">
									<div class="form-group">
										...
										<s:textfield class="form-control" id="request_username" name="user.username" required="true" />
									</div>
								</div>
								<div class="col-sm-6 col-xs-12">
									<div class="form-group">
										<label class="required" for="request_password">Mật khẩu</label>
										<s:textfield class="form-control" id="request_password" name="user.password" required="true" />
									</div>
								</div>
							</div>
						</div>
						<div class="box-footer">
							<div class="pull-right">
								<s:submit class="btn btn-primary" value="Sửa người dùng" />
							</div>
						</div>
					</div>
				</s:form>
